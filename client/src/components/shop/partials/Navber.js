    ...
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-10 shadow-lg lg:shadow-none bg-white">
        <div style={{ background: "#000" }}>
          <h3 style={{ color: "#fff", textAlign: "center", padding: "10px" }}>
          International Orders, Contact us at ({" "}
            <i style={{ color: "#fff" }} class="fa fa-phone"></i> +91-63691 
            35316 , <i style={{ color: "#fff" }} class="fa fa-envelope"> </i>   {"  "}
        ...
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            >
              <img src={require("../../shop/logo.png")} alt="logo" />
            </span>
          </div>
          <div
            onClick={(e) => history.push("/")}
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <Link style={{ marginBottom: "18px" }} to="/">
              {" "}
              <span
                style={{ color: "#000", fontFamily: 'EB Garamond, serif'
              }}
            ...
            <Link style={{ marginBottom: "18px" }} to="/aboutus">
              <span
                style={{ color: "#000", fontFamily: 'EB Garamond, serif' }}
                className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
                onClick={(e) => navberToggleOpen()}
            ...
            <Link style={{ marginBottom: "18px" }} to="/contact-us">
              <span
                style={{ color: "#000", fontFamily: 'EB Garamond, serif'}}
                className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
                onClick={(e) => navberToggleOpen()}
