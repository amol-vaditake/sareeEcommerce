...
// import { isWishReq, unWishReq, isWish, offerPrice } from "../home/Mixins";
...
// 	const [sizeMsg, setSizeMsg] = useState('Please enter size details for Leather Jacket in cm');
...
//     const parseElement = (description) => {
...
// 	function validateSizes(name){
// 		if(name !== 'Leather Jacket') return true
// 		let {length,waist,shoulder,bottom,sleeve,chest} = sizeData
// 		if(!length || !waist || !shoulder || !bottom || !sleeve || !chest){
// 			setSizeMsg("Please fill all the details")
// 			return false
// 		}
// 		return true
// 	}
...
//                 count === 3 ? "" : "opacity-25"
//               } cursor-pointer w-20 h-20 object-cover object-center`}
//               src={sProduct.pImages[3]}
//               alt="pic"
//             />
//              <img
//               onClick={(e) =>
//                 slideImage("increase", 4, count, setCount, pImages)
//               }
//               className={`${
//                 count === 4 ? "" : "opacity-25"
//               } cursor-pointer w-20 h-20 object-cover object-center`}
//               src={sProduct.pImages[4]}
//               alt="pic"
//             />
...
//               <div className="flex">
//               { sProduct.pOffer == 0 ?
//                 <span className="text-xl tracking-wider text-yellow-700">₹{sProduct.pPrice}</span>
//                 :
//                 <>
//                   <span className='text-l tracking-wider text-yellow-700 strikeThrough'>₹{sProduct.pPrice}</span>
//                   {/* <span className="text-xl tracking-wider text-yellow-700">&nbsp; ₹{sProduct.pPrice - (sProduct.pPrice * sProduct.pOffer/100)}</span> */}
//                   <span className="text-xl tracking-wider text-yellow-700">&nbsp; ₹{offerPrice(sProduct.pPrice, sProduct.pOffer)}</span>
//                 </>
//               }
//               </div>
//               {/* Price w/ Offer End */}
...
//                {/* <div className="flex">
//                   <span className="text-xl tracking-wider text-yellow-700 strikeThrough">
//                   ₹{sProduct.pPrice}
//                   </span>
//                   <span className="text-l tracking-wider text-yellow-700">
...
// 						{/* here we go */}
// 						<div>
// 							{sProduct.pName==='Leather Jacket' &&
// 						<form className="w-full">
// 							<div className="my-4 md:my-6 text-green-600" ><a target="_blank" href="https://res.cloudinary.com/duf961vt2/image/upload/v1618669833/new/2021-04-17T14:30:12.418Z1618669812400_size..jpg">Click here to view Size Chart</a></div>
...
// 							<div className="w-1/2 flex flex-col space-y-1">
// 								<label htmlFor="name">Sleeve</label>
// 								<input
// 									onChange={(e) =>
// 										setSizeData({
// 											...sizeData,
...
// 								<label htmlFor="name">Chest</label>
// 								<input
// 									onChange={(e) =>
// 										setSizeData({
// 											...sizeData,
...
// 							</div>
// 							<div className="flex flex-col space-y-1 w-1/2 ">
// 								<label htmlFor="name">Waist</label>
// 								<input
// 									onChange={(e) =>
// 										setSizeData({
// 											...sizeData,
...
// 										})
// 									}
// 									value={sizeData.bottom}
// 									className="px-4 py-2 border focus:outline-none"
// 									type="number"
// 								/>
// 							</div>
// 							<div className="flex flex-col space-y-1 w-1/2 ">
// 								<label htmlFor="name">Shoulder</label>
// 								<input
// 									onChange={(e) =>
// 										setSizeData({
// 											...sizeData,
...
// 							</div>
// 							</div>
// 							<div className="md:my-6 text-red-600">{sizeMsg}</div>
//           </form>}
// 						</div>
...
//                       <div
//                         onClick={(e) =>
//                           {if(validateSizes(sProduct.pName)){
//                             addToCart(
//                             sProduct._id,
//                             quantitiy,
//                             // sProduct.pPrice - (sProduct.pPrice*sProduct.pOffer/100),
//                             offerPrice(sProduct.pPrice, sProduct.pOffer),
//                             layoutDispatch,
//                             setQuantitiy,
//                             setAlertq,
//                             fetchData,
...
//                           }  }                      
//                         }
//                         style={{ background: "#000", marginTop:'10px', marginBottom:'10px' }}
                  ...
                  layoutData.inCart.includes(sProduct._id) === true ? (
                    ...
                    <div>
                      ...
                      <div
                        ...
                        style={{ background: "#abd752", marginTop:'10px', marginBottom:'10px' }}
                        className={`px-4 py-2 text-white text-center cursor-pointer uppercase`}
                      >
                        Add to cart
                      </div>
