...
const EditProductModal = (props) => {
  ...
  useEffect(() => {
    ...
    const blocksFromHTML = htmlToDraft(data.editProductModal.pDescription);
  ...
  const onEditorStateChange = (editorState) => {
    ...
    setEditformdata({
      ...
      error: false,
      success: false,
      pDescription: draftToHtml(convertToRaw(editorState.getCurrentContent())),
    })
  };
    ...
    <Fragment>
      ...
      >
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          ...
          {!editformData.loading?<form className="w-full" onSubmit={(e) => submitForm(e)}>
